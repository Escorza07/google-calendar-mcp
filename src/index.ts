...
interface FindFreeTimeArgs {
  timeMin: string;
  timeMax: string;
  duration: number;
}

function validateArgs<T>(args: unknown, requiredProps: (keyof T)[]): T {
    ...
    this.server.setRequestHandler(CallToolRequestSchema, async (request) => {
      try {
        switch (request.params.name) {
          case 'list_events': {
            const args = validateArgs<ListEventsArgs>(request.params.arguments, ['timeMin', 'timeMax']);
          ...
          case 'create_event': {
            const args = validateArgs<CreateEventArgs>(request.params.arguments, ['summary', 'start', 'end']);
          ...
          case 'update_event': {
            const args = validateArgs<UpdateEventArgs>(request.params.arguments, ['eventId']);
          ...
          case 'delete_event': {
            const args = validateArgs<DeleteEventArgs>(request.params.arguments, ['eventId']);
          ...
          case 'find_free_time': {
            const args = validateArgs<FindFreeTimeArgs>(request.params.arguments, ['timeMin', 'timeMax', 'duration']);
            ...
            while (currentTime < endTime) {
              ...
              const isConflict = busyPeriods.some(period => {
                ...
                return (
                  (currentTime >= periodStart && currentTime < periodEnd) ||
